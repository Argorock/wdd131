...
const nums = [10, 12, 8, 9, 11, 13, 7, 6, 15, 4, 17, 3, 2, 1, 5, 14, 16];

const numSort = nums.sort((a, b) => a - b); // much simpler than the function below
...
} // this is the same as the arrow function above, but much more complicated
...
let sortedHikes = filterHikes.sort((a, b) => {
    if (a.trailhead[0] < b.trailhead[0]) {
        return a.trailhead[1] - b.trailhead[1];
    }
    return a.trailhead[0] - b.trailhead[0];
});
